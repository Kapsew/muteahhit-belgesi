...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] font-[Inter]">
      ...
      {/* Hero — resmi + canlı önizleme */}
      <section className="relative overflow-hidden bg-[#0B1D3A]">
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-[#C9952B]" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-14 items-center">
            {/* Sol: resmi başlık */}
            <div>
              <div className="inline-flex items-center gap-2 border border-[#C9952B]/40 text-[#C9952B] px-3.5 py-1.5 rounded-[3px] text-[11px] tracking-[0.08em] uppercase mb-6">
                <Shield className="w-3.5 h-3.5" />
                Çevre ve Şehircilik Bakanlığı Formülleri
              </div>
              <h1 className="text-white leading-[1.18] mb-5 text-4xl md:text-[2.75rem] tracking-tight" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                Yetki belgesi sınıfınızı<br />
                <span className="text-[#C9952B] italic">eksiksiz</span> hesaplayın
              </h1>
              <p className="text-white/65 text-base leading-relaxed mb-8 max-w-md">
                İskan belgenizi yükleyin, Bakanlık yönetmeliğine göre yeterlilik grubunuzu ve iş deneyim tutarınızı resmi doğrulukta öğrenin.
              </p>
              <div className="flex flex-wrap gap-3 items-center">
                <button
                  onClick={() => navigate(user ? "/dashboard" : "/hizli-hesap")}
                  className="bg-[#C9952B] hover:bg-[#B8862A] text-[#0B1D3A] px-8 py-3.5 rounded-md text-[15px] font-medium flex items-center gap-2 transition-colors"
                >
                  {user ? "Panelime Git" : "Analize Başla"} <ArrowRight className="w-4 h-4" />
                </button>
                <a href="#nasil" className="text-white/70 hover:text-white px-5 py-3.5 border border-white/20 hover:border-white/40 rounded-md text-[15px] transition-colors">
                  Nasıl Çalışır?
                </a>
              </div>
              <div className="flex gap-7 mt-9 pt-7 border-t border-white/10">
                <div><div className="text-[#C9952B] text-xl font-medium">A–E</div><div className="text-white/50 text-xs mt-0.5">Tüm sınıflar</div></div>
                <div className="border-l border-white/10" />
                <div><div className="text-[#C9952B] text-xl font-medium">30 sn</div><div className="text-white/50 text-xs mt-0.5">Ortalama süre</div></div>
                <div className="border-l border-white/10" />
                <div><div className="text-[#C9952B] text-xl font-medium">2026</div><div className="text-white/50 text-xs mt-0.5">Güncel mevzuat</div></div>
              </div>
            </div>

            {/* Sağ: canlı önizleme kartı */}
            <div className="bg-white rounded-2xl p-5 shadow-xl shadow-black/20">
              <div className="flex items-center gap-2.5 p-3 bg-[#F8F9FB] rounded-xl border border-dashed border-[#C9952B]">
                <div className="w-9 h-9 bg-[#FAEEDA] rounded-lg flex items-center justify-center text-[#BA7517] shrink-0">
                  <FileText className="w-[18px] h-[18px]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[#0B1D3A] text-[13px] font-medium truncate">iskan_belgesi.pdf</div>
                  <div className="text-[#8A93A6] text-[11px]">yüklendi · okundu</div>
                </div>
                <CheckCircle className="w-5 h-5 text-[#1D9E75] shrink-0" />
              </div>

              <div className="text-center py-2 text-[#C9D0DC]"><ChevronDown className="w-4 h-4 mx-auto" /></div>

              <div className="grid grid-cols-2 gap-2">
                <div className="bg-[#F8F9FB] rounded-lg p-3"><div className="text-[#8A93A6] text-[11px]">Yapı sınıfı</div><div className="text-[#0B1D3A] text-[17px] font-medium">III.B</div></div>
                <div className="bg-[#F8F9FB] rounded-lg p-3"><div className="text-[#8A93A6] text-[11px]">Alan</div><div className="text-[#0B1D3A] text-[17px] font-medium">925 m²</div></div>
              </div>

              <div className="mt-2 bg-[#0B1D3A] rounded-xl px-4 py-3.5 flex items-center justify-between">
                <div><div className="text-white/60 text-[11px]">Yeterlilik grubu</div><div className="text-[#C9952B] text-[22px] font-medium">B Grubu</div></div>
                <Award className="w-7 h-7 text-[#C9952B]" />
              </div>
            </div>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          <div className="text-[#C9952B] text-[11px] tracking-[0.1em] uppercase mb-2.5">Neden Biz</div>
          <h2 className="text-[#0B1D3A] mb-2.5 text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>Süreci şansa bırakmayın</h2>
          <p className="text-[#6B7280] max-w-md mx-auto">Profesyonel analiz ve eksiksiz dosya yönetimiyle başvurunuzu güvenceye alın.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { icon: Zap, title: "Hızlı süreç", desc: "Analiziniz saniyeler içinde başlar, her dosya uzman ekibimizce kontrol edilir." },
            { icon: Lock, title: "Güvenli veri", desc: "Şirket ve kişisel bilgileriniz korunur, üçüncü taraflarla paylaşılmaz." },
            { icon: RefreshCw, title: "Güncel mevzuat", desc: "Yönetmelik ve harç tarifeleri sürekli takip edilir; başvurunuz her zaman uygun olur." },
          ].map((v) => (
            <div key={v.title} className="border border-[#EFEAE0] rounded-xl p-6 border-t-2 border-t-[#C9952B] hover:shadow-md transition-shadow bg-white">
              <div className="w-10 h-10 rounded-[10px] bg-[#FAF6EE] flex items-center justify-center text-[#C9952B] mb-3.5">
                <v.icon className="w-5 h-5" />
              </div>
              <h3 className="text-[#0B1D3A] text-base font-medium mb-1.5">{v.title}</h3>
      ...
      <section className="bg-[#FBFAF7] py-20 border-y border-[#EFEAE0]" id="nasil">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="text-[#C9952B] text-[11px] tracking-[0.1em] uppercase mb-2.5">Nasıl Çalışır</div>
            <h2 className="text-[#0B1D3A] text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>4 adımda raporunuza ulaşın</h2>
          </div>
          <div className="max-w-xl mx-auto relative">
            {/* vertical line */}
            <div className="absolute left-[19px] top-2 bottom-2 w-0.5 bg-[#EFEAE0]" />
            <div className="space-y-3.5">
              {[
                { num: "1", title: "İskan belgenizi yükleyin", desc: "Sistem belgeyi otomatik okur; tarih, alan ve sınıfı çıkarır.", son: false },
                { num: "2", title: "Otomatik analiz", desc: "Bakanlık birim maliyet ve Yİ-ÜFE tablolarıyla değeriniz hesaplanır.", son: false },
                { num: "3", title: "Raporunuzu görün", desc: "Yetki grubunuzu, iş bazlı tutarları ve mali yeterliliğinizi tek raporda görün.", son: false },
                { num: "4", title: "İndirin ve kullanın", desc: "Detaylı analizi indirin, başvurunuzda güvenle kullanın.", son: true },
              ].map((st) => (
                <div key={st.num} className="flex items-start gap-[18px] relative">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 relative z-10 text-[15px] font-medium ${st.son ? "bg-[#C9952B] text-[#0B1D3A]" : "bg-[#0B1D3A] text-[#C9952B]"}`}>
                    {st.num}
                  </div>
                  <div className="bg-white rounded-xl px-4 py-3.5 flex-1 border border-[#EFEAE0]">
                    <h4 className="text-[#0B1D3A] text-[15px] font-medium mb-0.5">{st.title}</h4>
                    <p className="text-[#6B7280] text-[13px] leading-snug">{st.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20" id="fiyat">
        <div className="text-center mb-4">
          <div className="text-[#C9952B] text-[11px] tracking-[0.1em] uppercase mb-2.5">Fiyatlandırma</div>
          <h2 className="text-[#0B1D3A] mb-2.5 text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>Tek seferlik hizmet bedeli</h2>
          <p className="text-[#6B7280] max-w-xl mx-auto">Şahıs şirketleri, limited şirketler ve kooperatifler için.</p>
        </div>
        <p className="text-center text-xs text-[#8A93A6] mb-12">Harçlar dahil değildir. Harç tutarları bakanlık tarifesine göre ayrıca tahsil edilir.</p>
      ...
      <section className="bg-white py-20 border-t border-[#0B1D3A]/8" id="referanslar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="text-[#C9952B] text-[11px] tracking-[0.1em] uppercase mb-2.5">Referanslar</div>
            <h2 className="text-[#0B1D3A] mb-2.5 text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>Bize güvenen firmalar</h2>
            <p className="text-[#6B7280] max-w-xl mx-auto">
              <span className="text-[#0B1D3A] font-medium">300'den fazla</span> müteahhit firmaya hizmet verdik, <span className="text-[#0B1D3A] font-medium">400'den fazla</span> başarılı başvuru tamamladık.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {visibleRefs.map((r, i) => {
              const colors = [
                "bg-[#0B1D3A]", "bg-[#1B3358]", "bg-[#264773]", "bg-[#0B1D3A]",
                "bg-[#1B3358]", "bg-[#264773]", "bg-[#0B1D3A]", "bg-[#1B3358]",
                "bg-[#264773]", "bg-[#0B1D3A]", "bg-[#1B3358]", "bg-[#264773]",
              ];
              ...
              return (
                <div
                  key={i}
                  className="bg-[#FBFAF7] rounded-xl px-4 py-3.5 border border-[#EFEAE0] hover:border-[#C9952B]/40 transition-colors"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20" id="mevzuat">
        <div className="text-center mb-12">
          <div className="text-[#C9952B] text-[11px] tracking-[0.1em] uppercase mb-2.5">Yasal Dayanak</div>
          <h2 className="text-[#0B1D3A] mb-2.5 text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>Mevzuat ve yönetmelikler</h2>
          <p className="text-[#6B7280] max-w-xl mx-auto">Yetki belgesi sürecinde dayanak oluşturan güncel mevzuat bilgileri.</p>
        </div>
      ...
      {/* CTA */}
      <section className="relative bg-[#0B1D3A] py-16">
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-[#C9952B]" />
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-white mb-4 text-2xl md:text-3xl" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400 }}>Yetki belgenizi almaya hazır mısınız?</h2>
